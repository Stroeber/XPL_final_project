...
function create_custom_views(){
    custom_views.first_practice = function(config) {
        const view = {
            name: config.name,
            CT: 0,
    ...
    custom_views.second_practice = function(config) {
        
    }

    custom_views.third_practice = function(config) {
        
    }

    custom_views.main_experiment = function(config) {
